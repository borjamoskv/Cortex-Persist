...
logger = logging.getLogger("inject_apex_100")

async def inject_primitives():
    logger.info("Iniciando inyección de Primitivas APEX-100...")
    ...
    md_path = "AUTODIDACT_APEX_100.md"
    ...
    logger.info(f"Encontradas {len(matches)} primitivas para inyectar.")

    agent_id = 99
    ultramap.update_agent_position(agent_id, 0.0, 0.0, 0.0, "APEX_100_ROOT", 0.0)
    ...
    for i, match in enumerate(matches):
        ...
        ultramap.update_agent_position(agent_id, (i + 1) * 1.0, 0.0, 0.0, "APEX_100_LEAF", 0.1)
