...
# Protocolo: C5-REAL | Inyección de Primitivas de Sistemas Complejos
...
logger = logging.getLogger("inject_sistemas_complejos")

async def inject_primitives():
    logger.info("Iniciando inyección de Primitivas SISTEMAS COMPLEJOS en CORTEX-Persist (C5-REAL)...")
    ...
    md_path = "AUTODIDACT_SISTEMAS_COMPLEJOS.md"
    ...
    agent_id = 98  # Agent ID reservado para SISTEMAS-COMPLEJOS INJECTOR
    ultramap.update_agent_position(agent_id, 0.0, 0.0, 0.0, "SISTEMAS_COMPLEJOS_ROOT", 0.0)
    ...
    for match in matches:
        ...
        try:
            ...
            ultramap.update_agent_position(agent_id, injected_count * 1.0, 0.0, 0.0, "SISTEMAS_COMPLEJOS_LEAF", 0.1)
