...
async def main() -> int:
    ...
    async def _maybe_skip(gate_num: int, fn: Callable[[], Coroutine[Any, Any, bool]]) -> bool:
        """Wrap any gate callable with SKIP_GATES check. Lazy: skipped gates never execute."""
