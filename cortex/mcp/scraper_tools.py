...
def register_scraper_tools(mcp) -> None:
    ...
    async def cortex_scrape(url: str, strategy: str = "auto") -> dict:
        ...
        """
        from cortex_extensions.scraper.engine import ScraperEngine
        from cortex_extensions.scraper.models import ExtractionStrategy, ScrapeRequest
    ...
    async def cortex_scrape_batch(
        ...
        """
        from cortex_extensions.scraper.engine import ScraperEngine
        from cortex_extensions.scraper.models import ExtractionStrategy
