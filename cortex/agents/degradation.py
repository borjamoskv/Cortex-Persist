...
Usage::
    ...
    from cortex.agents.degradation import (
        AgentAction,
        AgentResult,
        AgentDegradedError,
...
from cortex.agents.degradation_executor import (  # noqa: F401, E402
    _persist_to_cortex,
    _upgrade_to_l3,
    sovereign_execute,
)
...
from cortex.agents.degradation_types import (  # noqa: F401
    AgentAction,
