...
from cortex.jules.models import PlanOutput, ToolCall
from cortex.jules.tools import AgentToolkit

__all__ = ["ExecutorAgent"]

logger = logging.getLogger("cortex.jules.executor")

_MAX_ITERATIONS = 30

_SYSTEM = """You are a Sovereign Executor AI. You implement code changes step by step
using tools. You must follow the provided plan precisely.
