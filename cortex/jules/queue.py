"""MOSKV-Jules — SQLite-backed task queue.
...
logger = logging.getLogger("cortex.jules.queue")
...
class TaskQueue:
    """Thread-safe SQLite task queue for Jules agent tasks."""

    def __init__(self, db_path: Path | str | None = None) -> None:
        if db_path is None:
            db_path = Path.home() / ".cortex" / "jules.db"
