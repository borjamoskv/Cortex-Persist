...
logger = logging.getLogger("cortex.jules.tools")
...
class AgentToolkit:
    """Sandboxed tool set for the Jules Executor agent.
    ...
    def web_search(self, query: str) -> str:
        ...
        try:
            resp = httpx.get(
                ...
                timeout=10.0,
                headers={"User-Agent": "MOSKV-Jules/1.0"},
            )
            data = resp.json()
    ...
    def dispatch(self, tool_name: str, args: dict[str, str]) -> str:
        ...
        handlers: dict[str, callable] = {
            ...
            "git_commit": lambda a: self.git_commit(a.get("message", "jules: autonomous commit")),
