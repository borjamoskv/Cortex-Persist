...
def create(
    ...
    """
    from cortex_extensions.genesis import GenesisEngine, SystemSpec
...
def from_yaml(path: str) -> None:
    ...
    from cortex_extensions.genesis import GenesisEngine
...
def extend(
    ...
    """
    from cortex_extensions.genesis import ComponentSpec, GenesisEngine
...
def _default_components_for_type(system_type: str) -> list:
    ...
    from cortex_extensions.genesis import ComponentSpec
