...
@click.option(
    "--project", "-p", required=True, help="Target project name to evaluate."
)
@click.option(
...
def frontier_cmd(project: str, model: str | None):
    ...
    console.print(f"[bold magenta]🐺 Awakening Frontier Auditor for project: {project}...[/bold magenta]")
    ...
    if result["status"] == "SUCCESS":
        console.print(f"[bold green]✔ Audit executed via {result['provider']} "
        ...
        console.print(f"[bold red]❌ Critical failure during audit generation "
