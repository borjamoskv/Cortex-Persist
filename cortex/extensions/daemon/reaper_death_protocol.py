...
class ReaperDaemon:
    ...
    def evaluate_target(self, target_id: str, last_invocation: datetime, net_exergy: float, revenue_generated: float) -> str | None:
    ...
    def execute_purge(self, target_id: str, creation_date: datetime, exergy: float, reason: str) -> DeathCertificate:
