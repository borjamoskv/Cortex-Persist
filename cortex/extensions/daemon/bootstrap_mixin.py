"""Initialization helpers extracted from the daemon core."""
...
from cortex.extensions.daemon.models import CORTEX_DB, CORTEX_DIR, DEFAULT_DISK_WARN_MB
...
class DaemonBootstrapMixin:
    """Keeps the daemon core focused on orchestration and runtime control."""

    def _init_background_agents(self, file_config: dict[str, Any]) -> None:
        """Initialize autonomous background agents like Aether."""
        self._aether_daemon = None
        self.aether_monitor = None
    ...
    def _init_autopoiesis(self, file_config: dict[str, Any]) -> None:
    ...
    def _init_persistence_checkers(self, file_config: dict[str, Any]) -> None:
    ...
    def _init_sovereign_subsystems(self, file_config: dict[str, Any]) -> None:
        ...
        if _API_AVAILABLE and file_config.get("api_enabled", True):
            try:
                ...
                logger.info(
                    "🌐 Human Callback API ENABLED (port %s)",
