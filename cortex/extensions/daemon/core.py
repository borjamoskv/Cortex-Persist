...
class MoskvDaemon(AlertHandlerMixin, HealingMixin, LoopsMixin):
    ...
    def _init_autopoiesis(self, file_config: dict) -> None:
        ...
        if _CENTAUR_AVAILABLE:
            try:
                ...
                logger.info("HeartbeatDaemon (Continuous Autopoiesis) ENABLED")
        ...
        if _ZERO_PROMPTING_AVAILABLE:
            try:
                ...
                logger.info("Zero-Prompting Evolution Daemon (Axioma O7) ENABLED")
            except Exception as e:  # noqa: BLE001
        ...
        if _EPISTEMIC_BREAKER_AVAILABLE:
            try:
                ...
                logger.info("Sovereign Epistemic Circuit Breaker (Axioma O2, O3) ENABLED")
            except Exception as e:  # noqa: BLE001
    ...
    def _init_sovereign_subsystems(self, file_config: dict) -> None:
        ...
        if _SCHEDULER_AVAILABLE:
            try:
                ...
                logger.info("SovereignScheduler ENABLED")
            except Exception as e:  # noqa: BLE001
        ...
        if _WATCHDOG_HUB_AVAILABLE:
            try:
                ...
                logger.info("WatchdogHub ENABLED (%d paths)", len(watch_paths))
            except Exception as e:  # noqa: BLE001
    ...
    def check(self) -> DaemonStatus:
        ...
        level = "OK" if status.all_healthy else "WARN"
        logger.info(
    ...
    async def run_sovereign(self, interval: int = DEFAULT_INTERVAL) -> None:
        ...
        # Legacy thread-based subsystems
