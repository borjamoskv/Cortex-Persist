...
try:
    from watchdog.events import FileSystemEventHandler as _WatchdogFileSystemEventHandler
...
if _WatchdogFileSystemEventHandler is None:

    class _WatchHandlerStub:
        """Stub for missing watchdog."""

    _WatchHandlerBase: Any = _WatchHandlerStub
else:
    _WatchHandlerBase: Any = _WatchdogFileSystemEventHandler
...
if _WatchdogObserver is None:
    ...
    _ObserverType: Any = _ObserverStub
else:
    _ObserverType: Any = _WatchdogObserver
...
class _UnifiedHandler(_WatchHandlerBase):
