...
class MaestroUI:
    ...
    # ─── Nuevos Métodos Requeridos por el Test ──────────────────

    async def activate_app(self, app_name: str) -> InteractionResult:
        """Activa una aplicación por nombre."""
    ...
    async def click_menu_item(self, app_name: str, menu_path: list[str]) -> InteractionResult:
        """Hace click en un elemento de menú."""
