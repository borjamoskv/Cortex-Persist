"""
CORTEX Poet Engine — LORCA-Ω (Core)
=====================================
Sovereign narrative and commit generator — engine-layer component.

Transforms git diffs into compressed literary artifacts.
Generates remediation narratives for the Legion swarm.
Produces code comments, changelog entries, and swarm summaries.
