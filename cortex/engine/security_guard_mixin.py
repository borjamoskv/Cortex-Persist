"""Security guard mixin — injection, anomaly, and honeypot detection."""
...
__all__ = ["SecurityGuardMixin"]

logger = logging.getLogger("cortex")


class SecurityGuardMixin:
    """Anti-Hacker Shield. Runs injection, anomaly, and honeypot guards before storage."""
    ...
    def _guard_anomaly(
        ...
        try:
            from cortex.security.anomaly_detector import (
                DETECTOR,
                SecurityEvent,
            )
