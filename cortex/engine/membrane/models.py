...
class PureEngram(BaseModel):
    ...
    metadata: Dict[str, Any] = Field(default_factory=dict, description="Additional verified context")
    original_raw_hash: Optional[str] = Field(None, description="SHA-256 hash of the payload before digestion")
