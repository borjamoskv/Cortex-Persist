"""threat_feed_signatures — Built-in threat signatures for ThreatFeedEngine.

Extracted from threat_feed.py to satisfy the Landauer LOC barrier (≤500).
Contains: BUILT_IN_SIGNATURES list and pre-compiled _COMPILED_SIGNATURES.
"""
...
__all__ = ["BUILT_IN_SIGNATURES", "_COMPILED_SIGNATURES"]
