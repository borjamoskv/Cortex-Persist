...
class CortexTelemetry:
    ...
    def log_event(self, session_id: str, call_id: str, skill: str, event_type: str, 
                  source: str = "unknown", duration_ms: Optional[int] = None, 
                  success: Optional[bool] = None, trigger: str = "hook", **kwargs):
