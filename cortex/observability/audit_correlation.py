...
def audit_correlation(num_sessions=20):
    ...
    if mismatches:
        ...
        for m in mismatches[:10]:
            print(f" - Expected: {m['expected_tool']}, Actual step type: {m['actual_type']} in {os.path.basename(os.path.dirname(os.path.dirname(os.path.dirname(m['transcript']))))}")
