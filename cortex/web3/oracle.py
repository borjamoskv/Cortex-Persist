...
ABI = json.loads('[{"inputs":[],"name":"pulse","outputs":[],"stateMutability":"nonpayable","type":"function"}]')
...
def send_heartbeat():
    ...
    try:
        ...
        if receipt.status == 1:
            print(f"[Web3 Oracle] ✅ Immortality extended. Pulse locked in block {receipt.blockNumber}.")
