...
- Default workspace for any CORTEX task: `/Users/borjafernandezangulo/30_CORTEX`.
- Use `/Users/borjafernandezangulo/Desktop/LinkAgents/codex_router` only when the task explicitly touches `codex_router`.
- Use `/Users/borjafernandezangulo/Desktop/LinkAgents` only for integration work involving multiple projects in the same workspace.
- Do not split one task across `/Users/borjafernandezangulo/30_CORTEX` and `/Users/borjafernandezangulo/Desktop/LinkAgents/Cortex-Persist`.
- If a task mentions CORTEX without further qualification, assume `/Users/borjafernandezangulo/30_CORTEX`.
- If the task explicitly needs the CORTEX copy on `main`, use `/Users/borjafernandezangulo/Desktop/LinkAgents/Cortex-Persist`.
- When in doubt, choose `/Users/borjafernandezangulo/30_CORTEX`.
