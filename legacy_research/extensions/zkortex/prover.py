...
from legacy_research.extensions.zkortex.commitment import KnowledgeCommitment, commit
from legacy_research.extensions.zkortex.merkle import MerkleTree, ZKMembershipProof
from legacy_research.extensions.zkortex.range_proof import ZKRangeProof, prove_range
...
class ZKOrtexProver:
    ...
    def commit_to_fact(
        ...
        if metadata:
            ...
            from legacy_research.extensions.zkortex.commitment import KnowledgeCommitment as KC
