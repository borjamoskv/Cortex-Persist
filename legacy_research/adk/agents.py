...
def create_memory_agent(
    ...
    from legacy_research.extensions.adk.tools import ALL_TOOLS
...
def create_analyst_agent(
    ...
    from legacy_research.extensions.adk.tools import adk_search, adk_status
...
def create_guardian_agent(
    ...
    from legacy_research.extensions.adk.tools import adk_ledger_verify, adk_status
...
def create_google_one_agent(
    ...
    from legacy_research.extensions.adk.goog_tools import GOOGLE_ONE_TOOLS
