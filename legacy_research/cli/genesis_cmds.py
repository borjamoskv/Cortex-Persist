...
Thin CLI wrapper; all logic lives in babylon60.genesis.engine.
"""
...
def create(
    ...
    """
    from babylon60.extensions.genesis import GenesisEngine, SystemSpec
...
def from_yaml(path: str) -> None:
    ...
    from babylon60.extensions.genesis import GenesisEngine
...
def list_templates() -> None:
    ...
    from babylon60.extensions.genesis import TemplateRegistry
...
def extend(
    ...
    """
    from babylon60.extensions.genesis import ComponentSpec, GenesisEngine
...
def _default_components_for_type(system_type: str) -> list:
    ...
    from babylon60.extensions.genesis import ComponentSpec
