...
def routing_cheapest(intent: str, limit: int) -> None:
    ...
    from legacy_research.extensions.llm._presets import cheapest_providers, get_preset_info
...
def routing_frontier(intent: str) -> None:
    ...
    from legacy_research.extensions.llm._presets import frontier_providers, get_preset_info
...
def routing_status() -> None:
    ...
    from legacy_research.extensions.llm._presets import provider_inventory
