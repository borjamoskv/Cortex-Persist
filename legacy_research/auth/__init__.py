...
try:
    from legacy_research.auth.manager import AuthManager, get_auth_manager, reset_auth_manager
except ImportError:
...
try:
    from legacy_research.auth.schema import AUTH_SCHEMA, SQL_INSERT_KEY
except ImportError:
...
try:
    from legacy_research.auth.deps import (
        require_auth,
        require_consensus,
        require_permission,
