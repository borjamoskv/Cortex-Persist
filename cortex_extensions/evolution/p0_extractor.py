...
class P0VulnerabilityExtractor:
    ...
    Usage::
        ...
        from cortex_extensions.evolution.ouroboros_omega import OuroborosOmega
        from cortex_extensions.evolution.p0_extractor import P0VulnerabilityExtractor
    ...
    async def _dispatch_deepthink(self, prompt: str) -> str:
        ...
        try:
            ...
            from cortex_extensions.thinking.presets import OrchestraConfig
