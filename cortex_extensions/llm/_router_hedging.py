...
from cortex_extensions.llm._hedging import HedgedRequestStrategy
from cortex_extensions.llm._models import CascadeEvent, CascadeTier

if TYPE_CHECKING:
    from cortex.utils.result import Result
    from cortex_extensions.llm._cascade import CascadeManager
    from cortex_extensions.llm._models import BaseProvider, CortexPrompt
...
async def execute_swarm(
    ...
    from cortex_extensions.llm._models import ReasoningMode
