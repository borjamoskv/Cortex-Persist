...
if TYPE_CHECKING:
    from cortex_extensions.zkortex.commitment import KnowledgeCommitment
    from cortex_extensions.zkortex.merkle import MerkleTree, ZKMembershipProof
    from cortex_extensions.zkortex.opacity_layer import SovereignOpacityLayer
    from cortex_extensions.zkortex.prover import ZKOrtexProver
    from cortex_extensions.zkortex.range_proof import ZKRangeProof
    from cortex_extensions.zkortex.verifier import ZKOrtexVerifier
