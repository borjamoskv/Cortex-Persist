...
from cortex_extensions.zkortex.commitment import KnowledgeCommitment, commit
from cortex_extensions.zkortex.merkle import MerkleTree, ZKMembershipProof
from cortex_extensions.zkortex.range_proof import ZKRangeProof, prove_range
...
class ZKOrtexProver:
    ...
    def commit_to_fact(
        ...
        if metadata:
            ...
            from cortex_extensions.zkortex.commitment import KnowledgeCommitment as KC
