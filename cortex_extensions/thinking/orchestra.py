...
from cortex_extensions.thinking.orchestra_introspection import OrchestraIntrospectionMixin
from cortex_extensions.thinking.pool import ProviderPool, ThinkingRecord
from cortex_extensions.thinking.presets import (
    DEFAULT_ROUTING,
    MODE_SYSTEM_PROMPTS,
    OrchestraConfig,
    ThinkingMode,
)
from cortex_extensions.thinking.semantic_router import SemanticRouter
...
class ThoughtOrchestra(OrchestraIntrospectionMixin):
    ...
    def _resolve_mode_aware_fallbacks(
        ...
        """
        from cortex_extensions.thinking.presets import DEFAULT_ROUTING, ThinkingMode
