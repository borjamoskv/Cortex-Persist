...
Usage::
    ...
    from cortex_extensions.signals.trigger_engine import TriggerEngine
    from cortex_extensions.signals.trigger_registry import register_defaults
...
from cortex_extensions.signals.trigger_engine import (
    ActionType,
...
def _register_p0_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex_extensions.swarm.worktree_isolation",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex_extensions.swarm.swarm_heartbeat",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex_extensions.swarm.telemetry_gate",
        )
    )
...
def _register_p1_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex_extensions.swarm.byzantine",
        )
    )
...
def _register_p2_triggers(engine: TriggerEngine) -> None:
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex_extensions.signals.fact_hook",
        )
    )
    ...
    engine.register(
        TriggerCondition(
            ...
            source_module="cortex_extensions.swarm.error_ghost_pipeline",
        )
    )
