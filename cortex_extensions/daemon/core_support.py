...
from cortex_extensions.daemon.models import CORTEX_DB, CORTEX_DIR, DEFAULT_CERT_WARN_DAYS
...
from cortex_extensions.daemon.monitors.ast_oracle import ASTOracleMonitor
from cortex_extensions.daemon.sidecar.sentinel_monitor.monitor import SentinelMonitor
from cortex_extensions.daemon.sidecar.telemetry.fiat_oracle import FiatOracle

logger = logging.getLogger("moskv-daemon")

try:
    from cortex_extensions.aether.daemon import AetherDaemon, AetherMonitor
...
try:
    from cortex_extensions.daemon.sidecar.telemetry.iot_oracle import IoTOracle
...
def init_external_oracles(
    ...
    try:
        ...
        from cortex_extensions.daemon.sidecar.telemetry import ASTOracle
        ...
        try:
            from cortex_extensions.daemon.monitors.agy2_planner import AGY2PlannerMonitor
