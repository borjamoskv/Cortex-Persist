...
from cortex_extensions.sync import SyncResult, WritebackResult
from cortex_extensions.sync.common import file_hash, load_sync_state
...
class CortexSyncManager:
    ...
    async def _merkle_pulse_sync(self) -> SyncResult:
        ...
        from cortex_extensions.sync.common import MEMORY_DIR
