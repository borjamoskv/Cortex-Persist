...
class HealingMixin:
    ...
    def _heal_monitor(self, attr: str, monitor_name: str) -> None:
        ...
        the healed counter.
        """
        from cortex_extensions.daemon.core import MAX_CONSECUTIVE_FAILURES
    ...
    def _heal_entropy(self, cfg: dict) -> None:
        self.entropy_monitor = UnifiedMejoraloMonitor(
    ...
    def _heal_mejoralo(self, cfg: dict) -> None:
        self.auto_mejoralo = UnifiedMejoraloMonitor(
