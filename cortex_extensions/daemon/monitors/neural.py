...
from cortex_extensions.daemon.models import NeuralIntentAlert
...
class NeuralIntentMonitor:
    ...
    def check(self) -> list[NeuralIntentAlert]:
        ...
        try:
            from cortex_extensions.agents.neural import NeuralIntentEngine
            from cortex_extensions.platform.sys import is_macos
