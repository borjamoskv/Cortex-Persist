...
if TYPE_CHECKING:
    from cortex_extensions.daemon.monitors.auto_immune import AutoImmuneMonitor
    from cortex_extensions.daemon.monitors.cert import CertMonitor
    from cortex_extensions.daemon.monitors.cloud import CloudSyncMonitor
    from cortex_extensions.daemon.monitors.compaction import CompactionMonitor
    from cortex_extensions.daemon.monitors.disk import DiskMonitor
    from cortex_extensions.daemon.monitors.engine import EngineHealthCheck
    from cortex_extensions.daemon.monitors.epistemic import EpistemicMonitor
    from cortex_extensions.daemon.monitors.evaluation import EvaluationMonitor
    from cortex_extensions.daemon.monitors.ghosts import GhostWatcher
    from cortex_extensions.daemon.monitors.mejoralo import UnifiedMejoraloMonitor
    from cortex_extensions.daemon.monitors.memory import MemorySyncer
    from cortex_extensions.daemon.monitors.network import SiteMonitor
    from cortex_extensions.daemon.monitors.neural import NeuralIntentMonitor
    from cortex_extensions.daemon.monitors.perception import PerceptionMonitor
    from cortex_extensions.daemon.monitors.security import SecurityMonitor
    from cortex_extensions.daemon.monitors.signals import SignalMonitor
    from cortex_extensions.daemon.monitors.tombstone import TombstoneMonitor
    from cortex_extensions.daemon.monitors.trends import TrendsMonitor
    from cortex_extensions.daemon.monitors.workflow import WorkflowMonitor
