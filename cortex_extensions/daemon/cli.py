...
from cortex_extensions.daemon import (
    BUNDLE_ID,
    DEFAULT_COOLDOWN,
    DEFAULT_INTERVAL,
...
from cortex_extensions.platform.sys import get_service_dir, is_linux, is_macos, is_windows
...
def install() -> None:
    ...
    from cortex_extensions.daemon.platform import (
        install_linux,
        install_macos,
        install_windows,
    )
