...
from cortex_extensions.daemon.models import DaemonStatus
...
class LoopsMixin:
    ...
    def _auto_sync(self, status: DaemonStatus) -> None:
        ...
        if not self._shared_engine:
            return
        try:
            from cortex_extensions.sync import export_snapshot, export_to_json, sync_memory
    ...
    async def _run_health_loop_async(self) -> None:
        ...
        from cortex_extensions.daemon.health_loop import HealthLoop
