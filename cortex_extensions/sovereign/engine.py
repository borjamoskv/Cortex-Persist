...
from cortex_extensions.immune import ImmuneArbiter, Verdict
from cortex_extensions.sovereign.bridge import SovereignBridge
from cortex_extensions.sovereign.endocrine import DigitalEndocrine
from cortex_extensions.sovereign.observability import (
    Dimension,
    PowerLevel,
    compute_power,
    init_telemetry,
