...
from cortex_extensions.swarm.knowledge_radar import discover
from cortex_extensions.swarm.nightshift_pipeline import NightShiftPipeline
...
class NightShiftCrystalDaemon:
    ...
    async def _run_consolidation(self, cycle_id: str) -> dict[str, Any] | None:
        ...
        try:
            from cortex_extensions.swarm.crystal_consolidator import consolidate
