...
class TestMoskvAegisEngine:
    ...
    def test_constraint_modeler_fallback(self):
        ...
        from legacy_research.audit.moskv_aegis import MoskvAegisModeler
    ...
    def test_symbolic_attack_generator(self):
        ...
        from legacy_research.audit.moskv_aegis import MoskvAegisModeler
        from legacy_research.audit.moskv_videntia import MoskvVidentiaOracle
    ...
    def test_exploit_chain_constructor(self):
        ...
        from legacy_research.audit.moskv_videntia import MoskvVidentiaChainBuilder
