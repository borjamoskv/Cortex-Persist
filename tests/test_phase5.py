...
from cortex.aether.models import AgentTask, PlanOutput, TaskStatus
...
async def test_siege_verification_instruction_injection(mock_queue):
    ...
    with patch("cortex.aether.runner.PlannerAgent", return_value=planner_mock), \
         patch("cortex.aether.runner.ExecutorAgent", return_value=executor_mock), \
         patch("cortex.llm.provider.LLMProvider") as mock_llm_cls, \
         patch("cortex.aether.runner.AgentToolkit") as mock_toolkit:
