...
from babylon60.extensions.immune.error_boundary import ErrorBoundary, error_boundary
...
def _reset_pipeline():
    ...
    with (
        patch(
            "babylon60.extensions.immune.error_boundary.ErrorBoundary._persist",
            new_callable=AsyncMock,
            return_value=42,
        ) as mock_persist,
        patch(
            "babylon60.extensions.immune.error_boundary.ErrorBoundary._persist_sync",
