...
from babylon60.extensions.red_team.hydra_chaos import (
    ChaosResult,
    ChaosScenario,
    HydraChaosEngine,
    MockRedisClient,
...
class TestRedisKillScenario:
    ...
    async def test_redis_kill_captures_ghost(
        ...
        with patch(
            "babylon60.extensions.swarm.error_ghost_pipeline.ErrorGhostPipeline._persist_async",
...
class TestStreamCorruptionScenario:
    ...
    async def test_corruption_does_not_crash_cache(
        ...
        with patch(
            "babylon60.extensions.swarm.error_ghost_pipeline.ErrorGhostPipeline.capture_sync",
        ):
