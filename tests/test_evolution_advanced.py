...
class TestEvolutionEngine:
    ...
    async def test_adversarial_tournament(self, genesis_engine: EvolutionEngine):
        ...
        dummy_metrics = {
            AgentDomain.VERIFICATION: DomainMetrics(
                domain=AgentDomain.VERIFICATION, bridge_count=100, decision_count=50, error_count=0
            ),
            AgentDomain.FABRICATION: DomainMetrics(
                domain=AgentDomain.FABRICATION, bridge_count=0, decision_count=10, error_count=100
            ),
        }
    ...
    async def test_full_cycle_and_meta_fitness(
        self, mock_save, mock_fetch, genesis_engine: EvolutionEngine
    ):
