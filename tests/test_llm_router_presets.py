...
from legacy_research.extensions.llm._models import BaseProvider, IntentProfile
from legacy_research.extensions.llm._presets import (
    _PRESETS_CACHE,
    frontier_providers,
    load_presets,
...
class TestRouterOrdering:
    ...
    def test_cost_order_constants(self):
        from legacy_research.extensions.llm._router_policy import COST_ORDER
    ...
    def test_tier_order_constants(self):
        from legacy_research.extensions.llm._router_policy import TIER_ORDER
