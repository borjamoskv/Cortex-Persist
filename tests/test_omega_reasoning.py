...
async def test_omega_think_flow():
    ...
    with patch.object(orchestra, 'think', new_callable=AsyncMock) as mock_think:
        ...
        hypothesis = FusedThought(
            content="Hipótesis inicial perfecta.",
        ...
        with patch("cortex.llm.sovereign.Inquisitor") as mock_inquisitor_cls:
            ...
            mock_inquisitor.asediar = AsyncMock(return_value=AsyncMock(content="Crítica: Falta profundidad en X."))
            ...
            mock_inquisitor.asediar.assert_called_once_with("Hipótesis inicial perfecta.", original_prompt="¿Cómo asegurar la persistencia?")
