...
class TestTaintIntegration:
    async def test_deprecate_triggers_taint_propagation(self, engine):
        ...
        from legacy_research.engine.causality import KRGSE_DERIVED_FROM
        ...
        from legacy_research.engine.causality import KRGSE_TAINTED_BY
    ...
    async def test_invalidate_triggers_taint_propagation(self, engine):
        ...
        from legacy_research.engine.causality import KRGSE_DERIVED_FROM, KRGSE_TAINTED_BY
