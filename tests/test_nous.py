...
import pytest
from babylon60.extensions.nous.interpreter import NousCompiler, NousRuntime, NousIntentAST
...
def test_ast_nous_compiler() -> None:
    ...
    from babylon60.extensions.nous.compiler import NousCompiler as ASTNousCompiler
