...
from cortex_extensions.signals.models import Signal
...
class TestRegistry:
    def test_register_defaults_populates_engine(self) -> None:
        from cortex_extensions.signals.trigger_registry import (
            register_defaults,
        )
...
class TestSignalReactor:
    async def test_reactor_dispatches_to_trigger_engine(self) -> None:
        ...
        from cortex_extensions.signals.reactor import SignalReactor
