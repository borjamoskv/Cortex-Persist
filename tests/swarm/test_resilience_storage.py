...
from cortex.extensions.swarm.shamir_storage import split_secret, reconstruct_secret, Share
from cortex.extensions.swarm.ipfs_client import IPFSClient, IPFSError
from cortex.extensions.swarm.storage_router import StorageRouter, LocalBackend, IPFSBackend
from cortex.extensions.swarm.phoenix_handoff_adapter import PhoenixHandoffAdapter, HandoffPayload, RestorationError
...
async def test_ipfs_fetch_cascade():
    client = IPFSClient(gateway_url="http://local-fail:8080")
