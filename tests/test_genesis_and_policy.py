...
"""Tests for babylon60.genesis - GenesisEngine, SystemSpec, preview, CHRONOS-1.
...
class TestTemplateRegistry:
    def test_registry_has_builtins(self):
        from babylon60.extensions.genesis.templates import TemplateRegistry
...
class TestModelPolicyGuard:
    def test_clean_presets_no_warnings(self, caplog):
        ...
        from babylon60.extensions.llm._presets import _validate_model_policy

        with caplog.at_level(logging.WARNING, logger="babylon60.extensions.llm.presets"):
    ...
    def test_prohibited_tier_patterns(self):
        from babylon60.extensions.llm._presets import _PROHIBITED_TIERS
