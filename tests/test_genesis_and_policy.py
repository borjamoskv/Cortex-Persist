...
class TestSystemSpec:
    def test_from_dict_minimal(self):
        from cortex_extensions.genesis.models import SystemSpec
...
class TestTemplateRegistry:
    def test_registry_has_builtins(self):
        from cortex_extensions.genesis.templates import TemplateRegistry
...
class TestModelPolicyGuard:
    def test_clean_presets_no_warnings(self, caplog):
        ...
        from cortex_extensions.llm._presets import _validate_model_policy

        with caplog.at_level(logging.WARNING, logger="cortex_extensions.llm.presets"):
    ...
    def test_prohibited_tier_patterns(self):
        from cortex_extensions.llm._presets import _PROHIBITED_TIERS
