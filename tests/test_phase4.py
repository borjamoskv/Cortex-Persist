...
from cortex.swarm.auto_fix import AutoFixPipeline, FixAttempt, GhostClass
...
@pytest.mark.asyncio
@patch("cortex.swarm.auto_fix.AutoFixPipeline._execute")
@patch("cortex.swarm.auto_fix.AutoFixPipeline._autonomous_merge")
