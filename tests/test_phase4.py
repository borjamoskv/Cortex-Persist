...
def temp_repo(tmp_path):
    ...
    subprocess.run(["git", "config", "user.email", "tester@babylon60.com"], cwd=repo, check=True)
...
@patch("babylon60.extensions.swarm.auto_fix.AutoFixPipeline._autonomous_merge")
