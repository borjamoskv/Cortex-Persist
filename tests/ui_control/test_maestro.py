...
from cortex.ui_control.applescript import AppNotRunningError, UIElementNotFoundError, run_applescript
...
async def test_inject_keystroke_app_not_running(maestro):
    with patch("cortex.ui_control.maestro.is_app_running", new_callable=AsyncMock) as mock_is_running:
