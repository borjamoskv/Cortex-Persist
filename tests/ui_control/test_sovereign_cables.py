...
def test_perms_bootstrapper_check():
    ...
    with (
        ...
        patch("babylon60.extensions.ui_control.bootstrapper.ApplicationServices", mock_app_services),
        patch("babylon60.extensions.ui_control.bootstrapper.Quartz", mock_quartz),
    ):
        res = PermsBootstrapper.verify_and_prompt_permissions()
