...
Usage:
    python -m cortex_extensions.axioms.generate_docs
...
from babylon60.extensions.axioms.registry import (
    AXIOM_REGISTRY,
    AxiomCategory,
    by_category,
    enforced,
)
from babylon60.extensions.axioms.ttl import FACT_TTL, ttl_days
