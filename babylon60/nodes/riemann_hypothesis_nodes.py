...
class RiemannZeroNode(BaseModel):
    ...
    imaginary_part_scaled: str = Field(
        ..., description="Componente imaginaria en formato fixed-point BABYLON-60"
    )
    ...
    taint_signature: str = Field(
        ..., description="Sello Ouroboros BFT Taint (SAGA-2) para evitar Apoptosis celular."
    )
