...
Deliberately stochastic strategies (Adversarial, Entropy, Crossover, StagnationBreaker)
retain controlled randomness by design.
...
from babylon60.evolution.agents import (
    Mutation,
    MutationType,
    SovereignAgent,
    SubAgent,
)
from babylon60.evolution.cortex_metrics import CortexMetrics, DomainMetrics
...
class BridgeImportStrategy:
    ...
    More existing bridges in CORTEX DB → more aggressive knowledge transfer,
    reflecting a culture of proven cross-domain sharing.
    """
