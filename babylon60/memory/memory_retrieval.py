...
if TYPE_CHECKING:
    from babylon60.memory._protocols import CortexMemoryManagerProtocol as CortexMemoryManager
...
async def retrieve_episodic_context(
    ...
    if metamemory is not None and candidate_engrams:
        judgment = metamemory.judge_fok(None, candidate_engrams)  # type: ignore
