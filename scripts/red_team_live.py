...
async def simulate_attack(name: str, origin: str, vector: str, outcome: str, latency: str):
    ...
    if outcome == "BLOCKED":
        print(f"    {RED}{BOLD}✖ REJECTED:{RESET} {RED}Ledger integrity constraint violation. Exergy conserved.{RESET}")
    elif outcome == "QUARANTINED":
        print(f"    {BLUE}{BOLD}⊘ QUARANTINED:{RESET} {BLUE}State fork attempt isolated in Ephemeral Sandbox.{RESET}")
