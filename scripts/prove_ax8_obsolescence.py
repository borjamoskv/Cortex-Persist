...
async def run_simulation():
    ...
    limerent_signals = [
        SwarmSignal("Agent-1", "target_1", "SUCCESS", {"response": "The swarm believes we should act carefully. No code synthesized."}, {}),
        SwarmSignal("Agent-2", "target_2", "SUCCESS", {"response": "I agree with Agent-1, let's keep analyzing the problem space."}, {})
    ]
    ...
    crystallizing_signals = [
        SwarmSignal("Agent-1", "target_1", "SUCCESS", {"response": "We have synthesized the invariant:\n```python\ndef is_valid(): return True\n```"}, {}),
    ]
