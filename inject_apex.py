...
logger = logging.getLogger("inject_apex")
...
async def inject_primitives():
    ...
    agent_id = 99
    ultramap.update_agent_position(agent_id, 0.0, 0.0, 0.0, "APEX_ROOT", 0.0)
    ...
    for i, match in enumerate(matches):
        ...
        ultramap.update_agent_position(agent_id, (i + 1) * 1.0, 0.0, 0.0, "APEX_LEAF", 0.1)
