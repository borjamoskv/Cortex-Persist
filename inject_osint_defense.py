...
# Protocolo: C5-REAL | Inyección de Defensa Causal OSINT
...
logger = logging.getLogger("inject_osint_defense")

async def inject_primitives():
    logger.info("Iniciando inyección de Primitivas OSINT-DEF en CORTEX-Persist (C5-REAL)...")
    ...
    md_path = "AUTODIDACT_OSINT_EPISTEMIC_DEFENSE.md"
    ...
    agent_id = 105  # Agent ID reservado para OSINT DEFENSE INJECTOR
    ultramap.update_agent_position(agent_id, 0.0, 0.0, 0.0, "OSINT_DEF_ROOT", 0.0)
    ...
    for match in matches:
        ...
        try:
            ...
            ultramap.update_agent_position(agent_id, injected_count * 1.0, 0.0, 0.0, "OSINT_DEF_LEAF", 0.1)
