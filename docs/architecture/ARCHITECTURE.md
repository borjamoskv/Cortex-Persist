...
*Architecture stats (internal reference): 1,094 Python modules · 178,000 LOC · 15 engine mixins · 13 daemon monitors*
*CLI and API surfaces include both stable core commands and experimental/operator tooling. See §14 for maturity status.*
